                ...
                <div style={{ display: 'flex', justifyContent: 'center', gap: '15px', marginBottom: '60px', flexWrap: 'wrap' }}>
                    {categories.map((cat, index) => (
                        <button
                            ...
                            style={{
                                padding: '10px 25px',
                                background: filter === cat ? 'var(--accent-gold-gradient)' : 'var(--glass-bg)',
                                color: filter === cat ? '#000' : 'var(--text-off-white)',
                ...
                >
                    {filteredPartners.map((partner) => (
                        ...
                        >
                            ...
                            <div>
                                <h3 style={{ fontSize: '1.4rem', marginBottom: '5px', color: 'var(--text-white)' }}>{partner.nameKo}</h3>
